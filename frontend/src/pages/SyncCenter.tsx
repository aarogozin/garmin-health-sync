...
export function SyncCenterPage() {
  ...
  const schedule = useQuery({ queryKey: ['schedule'], queryFn: () => api<{ supported: boolean; installed: boolean; loaded: boolean; legacy: boolean; detail?: string }>('/schedule'), refetchInterval: busy ? 1000 : false })
